export default function IconSprite() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={{ display: 'none' }}>
      ...
      <symbol id="icon-more" viewBox="0 0 24 24"><path d="M12 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm0 2a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm0 6a2 2 0 1 0 0 4 2 2 0 0 0 0-4z"/></symbol>
      <symbol id="icon-moon" viewBox="0 0 24 24"><path d="M12.3 2a9 9 0 1 0 9.7 9.7 7 7 0 0 1-9.7-9.7z"/></symbol>
      <symbol id="icon-sun" viewBox="0 0 24 24"><path d="M12 7a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0-5 2 3h-4zm0 20-2-3h4zM2 12l3-2v4zm20 0-3 2v-4zM4.9 4.9l3.5.8-2.7 2.7zm14.2 14.2-3.5-.8 2.7-2.7zM19.1 4.9l-.8 3.5-2.7-2.7zM4.9 19.1l.8-3.5 2.7 2.7z"/></symbol>
      ...
      <symbol id="icon-phone" viewBox="0 0 24 24"><path d="M17 1H7a2 2 0 0 0-2 2v18a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2zm0 18H7V5h10zm-6 2h2v1h-2z"/></symbol>
      <symbol id="icon-sensors" viewBox="0 0 24 24"><path d="M7.76 4.84 6.34 3.42A11.94 11.94 0 0 0 2 12c0 3.35 1.38 6.38 3.59 8.56L7 19.14A9.95 9.95 0 0 1 4 12c0-2.8 1.15-5.34 3.01-7.16zm8.48 0A9.95 9.95 0 0 1 20 12c0 2.8-1.15 5.34-3.01 7.16l1.42 1.42A11.94 11.94 0 0 0 22 12c0-3.35-1.38-6.38-3.59-8.56zM12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z"/></symbol>
