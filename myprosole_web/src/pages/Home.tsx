    ...
    <div className="flex flex-col gap-5 px-4 py-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <span className="text-sm font-medium text-on-primary-container">Training</span>
        </Link>
        <Link
        ...
        >
          ...
          <span className="text-sm font-medium text-on-secondary-container">Tagebuch</span>
        </Link>
      </div>
