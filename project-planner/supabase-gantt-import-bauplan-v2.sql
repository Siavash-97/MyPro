...
-- All tasks assigned to Siavash. Start: 2026-08-17.
...
insert into planner_activity (id, ts, message, actor) values
  ('v2-act-import', now(), 'Bauplan v2 importiert: 30 Aufgaben + 1 Meilenstein, 35 Abhaengigkeiten, 8 Arbeitspakete (Phase 0-7), Ressource Siavash, Start 17.08.2026. Phasen 4/5/6 parallel moeglich.', 'Claude')
on conflict (id) do nothing;
