...
export function TaskEditModal() {
  ...
  function handleSave(closeModal = true): boolean {
    ...
    if (!task) {
      ...
      if (type !== 'milestone') {
        void confirmAndQueueAssignmentNotifications(newTaskId, notifiableNewAssignees([], assigneeIds, people));
      }
    ...
    if (!isSummary && type !== 'milestone') {
      void confirmAndQueueAssignmentNotifications(task.id, notifiableNewAssignees(task.assigneeIds, assigneeIds, people));
    }
