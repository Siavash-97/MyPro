...
| **Schritt** | Ein Bodenkontakt eines Fußes. Die natürliche Einheit für Merkmale. Am besten aus der Einlage; sonst nach der [Rangfolge](messquellen.md). |
| **Auswertung** | Der Vorgang, der aus Rohwerten Merkmale macht — egal, wo er läuft. |
| **Messgröße** | Was gemessen wird: Kadenz, Höhe, Herzfrequenz. Nicht zu verwechseln mit dem Gerät, das es misst. |
| **Quelle** | Woher ein Wert stammt: Einlage, Uhr, Telefonsensor, GPS. |
| **Rangfolge** | Welche Quelle je Messgröße vorgeht. Steht in [messquellen.md](messquellen.md). |
| **Herkunft** | Welche Quelle einen bestimmten Wert tatsächlich geliefert hat. Wird **immer** mitgespeichert. |
...
- **Bewegung** kommt aus dem GPS und weiß nichts von Füßen. **Schritt** ist ein Bodenkontakt. Die App darf nie aus dem einen das andere machen — auch nicht ungefähr.
